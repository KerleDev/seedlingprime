import sectorDataNew from "./sectorDataNew";
...
for (const [sectorKey, sectorNode] of Object.entries(sectorDataNew.sectors || {})) {
...
const asFraction = (v) => (Number.isFinite(v) ? (v > 1 ? v / 100 : v) : null);
...
export const uoUtils = { getStocksBySector, getStockMetrics, getStockName };